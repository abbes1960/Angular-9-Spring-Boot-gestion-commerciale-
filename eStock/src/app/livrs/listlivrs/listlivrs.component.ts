  ...
  import pdfMake from 'pdfmake/build/pdfmake';
    ...
    @Component({
      selector: 'app-listlivrs',
      templateUrl: './listlivrs.component.html',
      styleUrls: ['./listlivrs.component.scss']
    })
    export class ListlivrsComponent implements OnInit {
    p: number = 1;
    list : Livrs[];
    SearchText :string;
    constructor( private service :LivrsService,private router:Router,

  ...
  @Component({
    selector: 'app-add-lpreleve',
    templateUrl: './add-lpreleve.component.html',
    styleUrls: ['./add-lpreleve.component.scss']
  })
  export class AddLpreleveComponent implements OnInit {
    formData: Lb1016;
    articleList:Article[];
    isValid:boolean=true;
    constructor( public service:Lb1016Service,private toastr :ToastrService,
          @Inject(MAT_DIALOG_DATA)  public data,
          public dialogRef:MatDialogRef<AddLpreleveComponent>,

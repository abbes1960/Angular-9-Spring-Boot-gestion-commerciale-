...
@Component({
  selector: 'app-add-lproduction',
  templateUrl: './add-lproduction.component.html',
  styleUrls: ['./add-lproduction.component.scss']
})
export class AddLproductionComponent implements OnInit {
  ...
  constructor( public service:Lb1016Service,private toastr :ToastrService,
        ...
        public dialogRef:MatDialogRef<AddLproductionComponent>,

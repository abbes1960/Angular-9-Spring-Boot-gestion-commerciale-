...
public class Bon {
	@Id
	  ...
	  @JsonIgnore
	  @OneToMany(mappedBy = "bon", fetch=FetchType.EAGER)
      @Valid
	  private List<Lbon> lbons = new ArrayList<>();
	public long getId() {
		return id;
	}
	...
	public List<Lbon> getLbons() {
		return lbons;
	}
	public void setLbons(List<Lbon> lbons) {
		this.lbons = lbons;
	}
	public Bon(long id, int annee, int numero, int mat, int code, int codres, Date date_mvt, String libelle,
			double total, String lib_direction, String lib_residence, @Valid List<Lbon> lbons) {
		super();
		this.id = id;
		this.annee = annee;
		this.numero = numero;
	...
	public String toString() {
		return "Bon [id=" + id + ", annee=" + annee + ", numero=" + numero + ", mat=" + mat + ", code=" + code
				+ ", codres=" + codres + ", date_mvt=" + date_mvt + ", libelle=" + libelle + ", total=" + total
				+ ", lib_direction=" + lib_direction + ", lib_residence=" + lib_residence + ", lbons=" + lbons + "]";
	}

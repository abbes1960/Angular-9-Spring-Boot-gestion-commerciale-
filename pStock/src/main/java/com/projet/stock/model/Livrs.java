...
public class Livrs {
	...
	public List<Llivrs> getLlivrs() {
		return llivrs;
	}
	public void setLlivrs(List<Llivrs> llivrs) {
		this.llivrs = llivrs;
	}
	public Livrs(long id, int annee, int numero, int code, String libcl, Date date_mvt, String smtva, String chauffeur,
			String camion, double totht, double totrem, double totfodec, double tottva, double totttc, int numfac,
			@Valid List<Llivrs> llivrs) {
		super();
		this.id = id;
		this.annee = annee;
		this.numero = numero;
	...
	public String toString() {
		return "Livrs [id=" + id + ", annee=" + annee + ", numero=" + numero + ", code=" + code + ", libcl=" + libcl
